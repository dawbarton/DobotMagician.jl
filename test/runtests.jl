...
@testset "Offline tests" begin
    ...
    @test construct_command(get_device_name, (), false) ==
          UInt8[0xaa, 0xaa, 0x02, 0x01, 0x00, 0xff]
    @test_throws ArgumentError construct_command(get_device_name, (), true)
    @test construct_command(set_device_name, ("Hello",), false) ==
          UInt8[0xaa, 0xaa, 0x08, 0x01, 0x01, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x00, 0x0a]
    @test construct_command(
        set_ptp_po_cmd, (0x0, (0.2, 0.4, 0.6, 0.8), ((1, 2, 3), (4, 5, 6))), true
    ) == UInt8[
        0xaa,
        0xaa,
        0x1b,
    ...
    @test unpack_payload(get_device_name, UInt8[0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x00])[1] ==
          "Hello"
    @test unpack_payload(
    ...
    ) == ((60.0f0, 60.0f0, 60.0f0, 60.0f0), (60.0f0, 60.0f0, 60.0f0, 60.0f0))
end
